(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 964893, (e, t, r) => {
    ...
    function $(e, t, r, n) {
        ...
        return l.then(function() {
            ...
            m(l, t.id, t.bound), "__proto__" !== n && (r[n] = l), "" === n && null === u.value && (u.value = l), r[0] === h && "object" == typeof u.value && null !== u.value && u.value.$$typeof === h && (o = u.value, "3" === n) && (o.props = l), u.deps--, 0 === u.deps && null !== (l = u.chunk) && "blocked" === l.status && (o = l.value, l.status = "fulfilled", l.value = u.value, l.reason = null, null !== o && S(e, o, u.value, l))
        }, function(t) {
            if (!u.errored) {
    ...
    async function T(e, t, r) {
        ...
        if ("1" === M.headers.get(u.NEXT_ACTION_NOT_FOUND_HEADER)) throw Object.defineProperty(new o.UnrecognizedActionError(`Server Action "${v}" was not found on the server. 
        ...
        return T(e, l, t).then(async u => {
            ...
            if (e.pushRef.pendingPush = R, a.pendingPush = R, void 0 !== p) {
                ...
                if ((0, E.isExternalURL)(p)) {
                    let r = p.href;
                    return n(j(r, t)), (0, f.handleExternalUrl)(e, a, r, R)
                } {
            ...
            if (void 0 !== s) {
                ...
                if (void 0 !== t && t.isRootRender && void 0 !== d && void 0 !== h) {
                    let r = (0, c.createHrefFromUrl)(T),
                        ...
                        u = Date.now(),
                        o = (0, m.navigateToSeededRoute)(u, T, r, n, O, e.cache, w, M, l, !0);
