(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 306584, (e, t, n) => {
    ...
    let T = e => {
        ...
        z = n.forwardRef((e, t) => {
            ...
            let [eI, eP] = function(e, t, a, i, o, r, {
                tabs: l,
                tabPosition: d,
                rtl: s
            }) {
                let c, u, p;
                return ["top", "bottom"].includes(d) ? (c = "width", u = s ? "right" : "left", p = Math.abs(a)) : (c = "height", u = "top", p = -a), (0, n.useMemo)(() => {
                    if (!l.length) return [0, 0];
                    let n = l.length,
                        a = n;
                    for (let i = 0; i < n; i += 1) {
                        let n = e.get(l[i].key) || v;
                        if (Math.floor(n[u] + n[c]) > Math.floor(p + t)) {
                            a = i - 1;
                            break
                        }
                    }
                    ...
                    for (let t = n - 1; t >= 0; t -= 1)
                        if ((e.get(l[t].key) || v)[u] < p) {
                            i = t + 1;
                            break
                        }
                    return i > a ? [0, -1] : [i, a]
                }, [e, t, i, o, r, p, d, l.map(e => e.key).join("_"), s])
            ...
            let eX = K.map((e, t) => {
                ...
                ej = () => eb(() => {
                    ...
                    return K.forEach(({
                        ...
                        let a = J.current ? .querySelector(`[data-node-key="${k(n)}"]`);
                        if (a) {
                            let [i, o, r, l] = ((e, t) => {
                                let {
                                    offsetWidth: n,
    ...
    let G = 0,
        X = n.forwardRef((e, a) => {
            let {
                ...
                styles: P,
                ...T
            } = e, D = n.useMemo(() => (u || []).filter(e => e && "object" == typeof e && "key" in e), [u]), z = "rtl" === p, B = function(e = {
                inkBar: !0,
                tabPane: !1
            }) {
                let t;
                return (t = !1 === e ? {
                    ...
                    inkBar: !0,
                    ..."object" == typeof e ? e : {}
                }).tabPaneMotion && void 0 === t.tabPane && (t.tabPane = !0), !t.tabPaneMotion && t.tabPane && (t.tabPane = !1), t
